#!/usr/bin/env python3
"""
Batch generate images with DoLa-static (fixed j*, no early-exit) from a JSON prompts file.

CLI is aligned with run_batch_prompts.py, including fixed seed and batch settings.
"""
...
def parse_args():
    ap = argparse.ArgumentParser(description="Batch-generate with DoLa-static (no early-exit)")
